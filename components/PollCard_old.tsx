...
export default function PollCard({ 
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-xl hover:border-gray-200 transition-all duration-300 flex flex-col"
    >
      {/* Fixed Header - Always Visible */}
      <div className="p-4 pb-3 border-b border-gray-100 bg-gradient-to-br from-blue-50 to-purple-50">
        ...
        {status === 'upcoming' ? (
          <div className="flex items-center justify-center gap-1.5">
            {[
              ...
              <div key={index} className="flex flex-col items-center bg-white/80 rounded-lg px-2 py-1.5 border border-blue-200">
          ...
          <div className="flex items-start gap-2">
            {status === 'upcoming' && (
              <div className="relative flex items-center justify-center w-3.5 h-3.5 mt-0.5 shrink-0">
                <div className="absolute inset-0 w-3.5 h-3.5 bg-red-500 rounded-full animate-ping opacity-75"></div>
            ...
            <h3 className="text-base font-bold text-gray-900 leading-snug flex-1 line-clamp-2">{question}</h3>
          </div>
        </div>
      </div>
